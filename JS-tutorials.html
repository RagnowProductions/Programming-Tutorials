<head><title>Programming Tutorials Found Under "JavaScript"</title><link rel="icon" type="image/x-icon" href="Assets/pixil-frame-0 3.png">
...
<ol>
  ...
  <li> APPS USED - (iOS) KineMaster (Video Editing), Safari (Web Browser, Shown When Typing JS Commands.), Firefox (Web Browser, Shown When Porting JS), Files (Files App, Shown When Porting).</li>
